...
if __name__ == '__main__':
    ...
    # CATEGORY
    cat0 = Category.objects.create(name="currency")

    # APP CREATION
    app0 = Application.objects.create(category=cat0, name="Bitcoin")
    app0.providers.add(provider1, provider2)
    app1 = Application.objects.create(category=cat0, name="Bitcoin Cash")
    app1.providers.add(provider1, provider2)
    app2 = Application.objects.create(category=cat0, name="Bitcoin Gold")
    app2.providers.add(provider1)
    app3 = Application.objects.create(category=cat0, name="Bitcoin Private")
    app3.providers.add(provider1)
    app4 = Application.objects.create(category=cat0, name="Bitcoin testnet")
    app4.providers.add(provider1)
    app5 = Application.objects.create(category=cat0, name="Digibyte")
    app5.providers.add(provider1)
    app6 = Application.objects.create(category=cat0, name="HCash")
    app6.providers.add(provider1)
    app7 = Application.objects.create(category=cat0, name="Qtum")
    app7.providers.add(provider1)
    app8 = Application.objects.create(category=cat0, name="PIVX")
    app8.providers.add(provider1)
    app9 = Application.objects.create(category=cat0, name="Stealth")
    app9.providers.add(provider1)
    app10 = Application.objects.create(category=cat0, name="Vertcoin")
    app10.providers.add(provider1)
    app11 = Application.objects.create(category=cat0, name="Viacoin")
    app11.providers.add(provider1)
    app12 = Application.objects.create(category=cat0, name="Ubiq")
    app12.providers.add(provider1)
    app13 = Application.objects.create(category=cat0, name="Expanse")
    app13.providers.add(provider1)
    app14 = Application.objects.create(category=cat0, name="Dash")
    app14.providers.add(provider1)
    app15 = Application.objects.create(category=cat0, name="Dogecoin")
    app15.providers.add(provider1)
    app16 = Application.objects.create(category=cat0, name="Ethereum")
    app16.providers.add(provider1, provider2)
    app17 = Application.objects.create(name="Fido U2F")
    app17.providers.add(provider1)
    app18 = Application.objects.create(category=cat0, name="Litecoin")
    app18.providers.add(provider1)
    app19 = Application.objects.create(category=cat0, name="Stratis")
    app19.providers.add(provider1)
    app20 = Application.objects.create(category=cat0, name="Ripple")
    app20.providers.add(provider1, provider2)
    app21 = Application.objects.create(category=cat0, name="Zcash")
    app21.providers.add(provider1)
    app22 = Application.objects.create(category=cat0, name="ZenCash")
    app22.providers.add(provider1)
    app23 = Application.objects.create(category=cat0, name="Komodo")
    app23.providers.add(provider1)
    app24 = Application.objects.create(category=cat0, name="Peercoin")
    app24.providers.add(provider1)
    app25 = Application.objects.create(category=cat0, name="PoSW")
    app25.providers.add(provider1)
    app26 = Application.objects.create(category=cat0, name="Ark")
    app26.providers.add(provider1)
    app27 = Application.objects.create(category=cat0, name="Neo")
    ...
    app30 = Application.objects.create(category=cat0, name="Stellar")
    app30.providers.add(provider1)
    app31 = Application.objects.create(category=cat0, name="Woleet")
    app31.providers.add(provider1)
    app32 = Application.objects.create(category=cat0, name="Monero")
    ...
    app35 = Application.objects.create(category=cat0, name="Nano")
    app35.providers.add(provider1)
    app36 = Application.objects.create(category=cat0, name="Nimiq")
    app36.providers.add(provider1)
    app37 = Application.objects.create(category=cat0, name="DasCoin")
    app37.providers.add(provider2)
    app38 = Application.objects.create(category=cat0, name="Stealthcoin")
    app38.providers.add(provider1)
    app39 = Application.objects.create(category=cat0, name="Clubcoin")
    app39.providers.add(provider1)
    app40 = Application.objects.create(category=cat0, name="Bitcoin Beta")
